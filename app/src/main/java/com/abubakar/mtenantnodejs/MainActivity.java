package com.abubakar.mtenantnodejs;
...
import com.abubakar.mtenantnodejs.Model.BraintreeToken;
import com.abubakar.mtenantnodejs.Model.BraintreeTransaction;
import com.abubakar.mtenantnodejs.retrofit.IBraintreeAPI;
import com.abubakar.mtenantnodejs.retrofit.RetrofitClient;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE)
        {
            ...
            {
                DropInRequest result = data.getParcelableExtra(DropInResult.EXTRA_DROP_IN_RESULT);
